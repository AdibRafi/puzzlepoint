...
//    Route::delete('/profileA', [ProfileAController::class, 'destroy'])->name('profileA.destroy');
    ...
    Route::post('/remove-student', [ClassroomController::class, 'removeStudentFromClassroom'])->name('add-student.remove');
    ...
    Route::get('assessment-end-session', [AssessmentController::class, 'endAssessmentSession'])->name('end.assessment.session');
