                    ...
                    <div class="grid grid-flow-col gap-5 text-center auto-cols-max my-4">
                        <div class="flex flex-col p-2 bg-primary rounded-box text-neutral-content">
                            <span class="countdown font-mono text-5xl">
                              <span id="minuteElement" :style="'--value:' + props.topicModal.max_time_expert + ';'"></span>
                            </span>
                            min
                        </div>
                        <div class="flex flex-col p-2 bg-primary rounded-box text-neutral-content">
        ...
        <div class="card w-96 bg-base-100 shadow-xl my-4">
            <div class="card-body">
                ...
                <div class="my-4">
                    ...
                    <p class="my-10">{{ props.topicModal }}</p>
                </div>
            </div>
        </div>
        <!--    <div>-->
...
let minuteCounter = props.topicModal.max_time_expert;
let secondCounter = 0;
setInterval(() => {
    if (secondCounter > 0) {
        secondCounter--;
