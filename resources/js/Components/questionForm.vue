                    ...
                    <div v-else>
                        <div class="form-control">
                            ...
                            <textarea class="textarea textarea-bordered textarea-primary h-24 w-72"
                                      placeholder="Type Here" v-model="form.answer.name"/>
                        </div>
                    </div>
                </div>
            </div>
...
const props = defineProps({
    ...
    rightAnswer: String,
    answerName: Object,
    radioAnsNumber: Number,
    checkAnsNumber: Number,
...
const form = useForm({
    ...
    answer: {
        name: props.answerName,
        right_answer: props.rightAnswer
    }
})
onUpdated(function () {
    form.reset();
...
const radioAnsNumber = ref(props.radioAnsNumber);

const checkAnsNumber = ref(props.checkAnsNumber);
const resetAns = () => {
